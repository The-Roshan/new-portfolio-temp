              ...
              <ul className="custom-list">
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">+91 XXX XXX XXXX</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">roshan.kumar@email.com</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">roshan.kumar</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
